page 50059 "Dispatch Challan"
{
    Caption = 'Dispatch Challan';
    PageType = Document;
    ...
    AboutTitle = 'About Dispatch Challan details';
    AboutText = 'Choose the order details and fill in order lines with quantities of what you are selling. Post the order when you are ready to ship. This creates posted sales shipments';
    ...
    layout
    {
        area(content)
        {
            ...
            part(SalesLines; "Dispatch Challan Subform")
            {
                ApplicationArea = Basic, Suite;
...
#pragma warning restore
    ...
    var
        ...
        InstructionMgt: Codeunit "Instruction Mgt.";
    begin
        if not OrderSalesHeader.Get(rec."Document Type", "No.") then begin
