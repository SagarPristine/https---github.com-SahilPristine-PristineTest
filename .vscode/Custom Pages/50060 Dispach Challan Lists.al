page 50060 "Dispach Challan Lists"
{
    ApplicationArea = Basic, Suite, Assembly;
    Caption = 'Dispatch Challan lists';
    CardPageID = "Dispatch Challan";
    DataCaptionFields = "Sell-to Customer No.";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Request Approval,Order,Release,Posting,Print/Send,Navigate';
    QueryCategory = 'Dispatch Challan List';
    RefreshOnActivate = true;
    SourceTable = "Sales Header";
    SourceTableView = WHERE("Document Type" = CONST(Order), "Document SubType" = filter(<> " "));
    UsageCategory = Lists;
