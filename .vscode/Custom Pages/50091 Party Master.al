page 50091 "Party Master List"
{
    ApplicationArea = Basic, Suite, Service;
    Caption = 'Party Master';
    CardPageID = "Party Master Card";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Approve,New Document,Request Approval,Customer,Navigate,Prices & Discounts';
    QueryCategory = 'Party Master List';
    RefreshOnActivate = true;
    SourceTable = Customer;
    UsageCategory = Lists;
    SourceTableView = where("Is party" = filter(true));

    AboutTitle = 'About party Master';
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            {
                ApplicationArea = Suite;
                Caption = 'Insert Party';
                Image = Reminder;
                Promoted = true;
                PromotedCategory = Category5;
                PromotedIsBig = true;
                ToolTip = 'It will create or modify customer and vendor for this party';
                AboutTitle = 'Insert Party';
                AboutText = 'Get started on a new reminder, order, or other document for the customer selected in the list.';
            }
                ...
                begin
                    ...
                    if Rec.FindSet() then begin
                        repeat
                            ...
                            Vendor.Validate("Vendor Type", Rec."Vendor Type");
                            vendor.Validate("Vendor Posting Group", Rec."Customer Posting Group");
                            vendor.Validate("Gen. Bus. Posting Group", Rec."Gen. Bus. Posting Group");
                            vendor.Validate("VAT Bus. Posting Group", rec."VAT Bus. Posting Group");
                            vendor.Validate("GST Registration No.", Rec."GST Registration No.");
                            vendor.Validate("P.A.N. No.", Rec."P.A.N. No.");
                            vendor.Validate("Payment Terms Code", Rec."Payment Terms Code");
                            vendor.Validate("Mobile Phone No.", Rec."Mobile Phone No.");
                            vendor.Validate("VAT Registration No.", Rec."VAT Registration No.");
