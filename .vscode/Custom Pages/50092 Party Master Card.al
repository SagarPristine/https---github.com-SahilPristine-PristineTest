page 50092 "Party Master Card"
{
    Caption = 'Party Master Card';
    PageType = Card;
    ...
    AboutTitle = 'About Party Master details';
    AboutText = 'With the **Party Master Card** you manage information about a customer and specify the terms of business, such as payment terms, prices and discounts. From here you can also drill down on past and ongoing sales activity.';
        ...
        area(content)
        {
            ...
            group(Invoicing)
            {
                ...
                group(PostingDetails)
                {
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Customer/Vendor Posting Group';
                        Importance = Promoted;
                        ShowMandatory = true;
        ...
        if GuiAllowed then
            if "No." = '' then
                if DocumentNoVisibility.CustomerNoSeriesIsDefault then
                    NewMode := true;
        "Is party" := true; //PBS-SAG tagging for party master tracking.
    end;
