page 50095 "Seed Arrival Subform"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Production Lot Status"; Rec."Production Lot Status")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Production Lot Status field.';
                }
                field("No."; "No.")
                {
                ...
                field(Bardana; Rec.Bardana)
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Bardana field.';
                }
